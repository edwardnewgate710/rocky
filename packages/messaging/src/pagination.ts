/** Options for paginating a messaging query. */
 ...
 * The Postgres adapter handles it explicitly for that reason; the same claim made about the social
 * graph in ADR-0066 turned out to be true of the domain and false of the adapter.
 */
