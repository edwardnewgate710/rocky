...
| M12 | api security & anti-cheat | 🚧 **increments 1–3 complete:** CORS + security headers (ADR-0011) · httpOnly refresh cookie (ADR-0012) · auth rate limiting w/ Postgres buckets (ADR-0013) · **anti-cheat inc 1:** engine-correlation analyzer (ADR-0029) | 8 (anti-cheat) |
...
**Whole repo: 937 total tests, 0 failures** (skips: 11 Postgres-gated + 18
