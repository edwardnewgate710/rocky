...
- **It is asked once.** The controller also latches on the first 503 and stops calling for the rest of the page session, so a second profile view costs nothing rather than two more requests.
