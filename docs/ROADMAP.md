...
**Bot Detection Increment 1 complete:** pure domain behavioral move-time analyzer (ADR-0036). Remaining bot-detection wiring (timing extraction/aggregation/API/triggers) and the pen-test pass remain.
