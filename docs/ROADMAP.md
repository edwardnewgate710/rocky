...
**Bot Detection Increments 1–2 complete:** pure domain behavioral move-time analyzer (ADR-0036) and cross-game behavioral aggregation (ADR-0037). Remaining bot-detection wiring (timing extraction/persistence/API/triggers) and the pen-test pass remain.
