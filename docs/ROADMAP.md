...
**Bot Detection Increments 1–5 complete:** pure domain behavioral move-time analyzer (ADR-0036), cross-game behavioral aggregation (ADR-0037), move-timing extraction (ADR-0038), service + report repository (ADR-0039), and Postgres persistence + moderation REST API (ADR-0040). Remaining automatic triggering and the pen-test pass remain.
